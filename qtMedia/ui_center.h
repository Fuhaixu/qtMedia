...
public:
    ...
    void setupUi(QDialog *Center)
    {
        ...
        btnDraw_2 = new QPushButton(groupBox);
        btnDraw_2->setObjectName(QStringLiteral("btnDraw_2"));
        btnDraw_2->setGeometry(QRect(240, 110, 101, 31));
        ...
        label_3->setGeometry(QRect(170, 180, 101, 31));
        label_4 = new QLabel(groupBox);
        label_4->setObjectName(QStringLiteral("label_4"));
        label_4->setGeometry(QRect(90, 210, 211, 16));
    ...
    void retranslateUi(QDialog *Center)
    {
        ...
        label->setText(QApplication::translate("Center", "\346\216\247\345\210\266\344\270\255\345\277\203", Q_NULLPTR));
        label_2->setText(QApplication::translate("Center", "Center", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("Center", "BY Fuhaixu", Q_NULLPTR));
        ...
        btnDraw_2->setText(QApplication::translate("Center", "\346\227\266\351\222\237\345\212\250\347\224\273", Q_NULLPTR));
