/********************************************************************************
** Form generated from reading UI file 'vediodlg.ui'
**
...
#ifndef UI_VEDIODLG_H
#define UI_VEDIODLG_H
...
public:
    ...
    void setupUi(QDialog *VedioDlg)
    {
        if (VedioDlg->objectName().isEmpty())
            VedioDlg->setObjectName(QStringLiteral("VedioDlg"));
        VedioDlg->resize(905, 521);
        commandLinkButton = new QCommandLinkButton(VedioDlg);
        commandLinkButton->setObjectName(QStringLiteral("commandLinkButton"));
        commandLinkButton->setGeometry(QRect(30, 10, 187, 41));
        groupBox = new QGroupBox(VedioDlg);
        groupBox->setObjectName(QStringLiteral("groupBox"));
        groupBox->setGeometry(QRect(10, 60, 881, 441));
        ...
        videoWidget->setGeometry(QRect(240, 50, 621, 301));
        ...
        retranslateUi(VedioDlg);

        QMetaObject::connectSlotsByName(VedioDlg);
    } // setupUi

    void retranslateUi(QDialog *VedioDlg)
    {
        VedioDlg->setWindowTitle(QApplication::translate("VedioDlg", "Dialog", Q_NULLPTR));
        commandLinkButton->setText(QApplication::translate("VedioDlg", "\350\277\224\345\233\236", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("VedioDlg", "\350\247\206\351\242\221", Q_NULLPTR));
        btnPlay->setText(QString());
        btnStop->setText(QString());
        btnPause->setText(QString());
        btnPush->setText(QApplication::translate("VedioDlg", "\345\205\250\345\261\217", Q_NULLPTR));
        btnSound->setText(QString());
        btnPre->setText(QString());
        btnSuf->setText(QString());
        labRatio->setText(QApplication::translate("VedioDlg", "\350\277\233\345\272\246", Q_NULLPTR));
        labelFile->setText(QApplication::translate("VedioDlg", "\346\226\207\344\273\266\350\267\257\345\276\204:", Q_NULLPTR));
        btnFile->setText(QApplication::translate("VedioDlg", "...", Q_NULLPTR));
...
namespace Ui {
    class VedioDlg: public Ui_VedioDlg {};
} // namespace Ui
